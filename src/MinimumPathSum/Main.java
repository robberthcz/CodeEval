 ...
 * delimited). After the n rows, the pattern repeats. E.g. 2 4,6 2,8 3 1,2,3
 * 4,5,6 7,8,9
 * 
 * Output sample:
 * 
 * Print out the minimum path sum for each matrix. E.g. 14 21
 * 
 * @author Robb
 *
 */
