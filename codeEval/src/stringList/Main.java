...
public class Main {
	...
	private void dfs(int row, int column, char[] keypad, StringBuilder permutation) {
        ...
        // modify back the intermediate string for other recursive calls
		permutation.deleteCharAt(permutation.length() - 1);
	}

	public static void main(String args[]) throws FileNotFoundException {
		Scanner textScan = new Scanner(new FileReader("src/StringList/input.txt"));
